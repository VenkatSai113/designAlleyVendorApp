...
class Profile extends Component{
    ...
    componentDidMount=async()=>{
        ...
        const url="https://database2-adarsh057.onrender.com/profileData";
        const options={
            headers:{
        ...
        return(
            ...
            <div className="saved-feed-container ">
                <div className="saved-profile-div">
                    <div>
                    <img src="https://media.istockphoto.com/id/1189303518/photo/success-businessman-smiling-in-office.jpg?s=612x612&w=0&k=20&c=v923lu7wmxWxXYIYbkBxxsOsPh1AcbOD2kSrwVv9rIY=" alt="profile" className="profile-image-profilepic"/>
