...
addressStatus:false,emailStatus:false,emailError:"",areaStatus:false,budgetStatus:false,bankNameStatus:false,accountNumberStatus:false,branchStatus:false,ifscCodeStatus:false,PhoneNumberStatus:false,responseData:""}
...
requiredHandle=(event)=>{
    ...
    onSubmitSignUp=async()=>{
        ...
        if(name!==""&&address!==""&&email!=="",area!==""&&budget!==""&&bankName!==""&&accountNumber!==""&&branch!==""&&ifscCode!==""&&PhoneNumber!==""){
            ...
            const url="https://nodejs2-adarsh057.onrender.com/designer/signup/"
    ...
    render(){
        const {name,open,userState,address,email,area,budget,bankName,accountNumber,branch,ifscCode,nameError,nameStatus,emailStatus,areaError,budgetError,bankNameError,accountNumberError,branchError,ifscCodeError,
            addressStatus,PhoneNumber,PhoneNumberError,PhoneNumberStatus,emailError,areaStatus,budgetStatus,bankNameStatus,accountNumberStatus,addressError,branchStatus,ifscCodeStatus,responseData}=this.state
        return(
      ...
      <Snackbar open={open} autoHideDuration={6000} >
        {userState? <Alert severity="success" sx={{ width: '100%' }}>
        {  responseData}
        </Alert>:<Alert severity="error">  {  responseData}</Alert>}
