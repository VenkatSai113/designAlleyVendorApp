...
class CreatePost extends Component{
    ...
    filterUser=async(event)=>{
       ...
       const searchingResult=userProfiles.filter(eachItem=>
        ...
        const searchApi="https://database2-adarsh057.onrender.com/selectedUsers";
        const options={
            method:"POST",
            headers:{
    ...
    componentDidMount=async()=>{
        const apiUrl="https://nodejs2-adarsh057.onrender.com/relatedUsers";
        const options={
             methos:"GET"
        }
    ...
    onClickPost=async()=>{
        ...
        const url= "https://database2-adarsh057.onrender.com/post"
