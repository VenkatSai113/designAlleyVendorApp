                         ...
                         <div className="curated-architects-designers">
                           <div className='curated-architects-designers-body'>
                              ...
                              <h1 className="shop-Curated-text">Curated with love for architects & designers</h1>
                               <p className="material-depot-text">Material Depot curates materials from top brands in<br></br> India for ready to be deployed for your 3D<br></br> renderings</p>
                               <div className='d-flex flex-row'>
                            ...
                            <img className="curated-architects-image" src="https://materialdepot.in/static/media/modern-style-interior-design-3d-rendering-2021-08-26-18-15-32-utc%201.ca37b80a.png" alt=""/>
                           </div>
                           </div>
                           <div className="curated-architects-designers">
                           <div className='curated-architects-designers-body'>
                           <img className="curated-architects-image" src="https://materialdepot.in/static/media/homecard2.605b31bb.png" alt=""/>
                              ...
                              <h1 className="shop-Curated-text">Super fast material search that saves your design time.</h1>
                               <p className="material-depot-text">Material Depot curates materials from top lining brands for ready to be deployed for your 3D renderings.</p>
                               <div className='d-flex flex-row'>
                               <p>< MdVerifiedUser className='verified-icon'/></p>
